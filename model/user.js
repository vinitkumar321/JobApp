...
export default class UserModel {
  static async get_user(user_id) {
    console.log(`Model :: user :: get_user : user_id = ${user_id}`)
    let get_user_query = `SELECT * FROM USERS WHERE ID=${user_id}`
    console.log(`Model :: user :: get_user :: Query = ${get_user_query}`)
    ...
    return new Promise((resolve, reject) => {
      pool.query(get_user_query, (err, results) => {
        ...
        console.log('Model :: user :: get_user : results = ', results)
        resolve(results)
      })
    })
  }
  ...
  static async get_all_users() {
    ...
    console.log(`Model :: user :: get_all_users : Query = ${get_all_users_query}`)
    ...
    return new Promise((resolve, reject) => {
      pool.query(get_all_users_query, (err, results) => {
        ...
        console.log('Model :: user :: get_all_users : results = ', results)
        resolve(results)
      })
    })
  }
  ...
  static async create_user(user_id, first_name, last_name) {
    ...
    console.log(`Model :: user :: create_user : Query = ${query}`)
    ...
    return new Promise((resolve, reject) => {
      pool.query(query, (err, results) => {
        ...
        console.log('Model :: user :: create_user : results = ', results)
        resolve(results)
      })
    })
  }
